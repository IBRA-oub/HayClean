...
import useMunciProfile from '../../hooks/municipalityHooks/useMunciProfile';
import EditeProfile from '../../components/municipalityComponents/EditeProfile';

const muniProfile = () => {
  const { isModalVisible, userData,setModalVisible, handleDelete, handleLogout, handleEditSubmit } = useMunciProfile()
  return (

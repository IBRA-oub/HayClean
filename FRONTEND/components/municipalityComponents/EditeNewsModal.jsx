...
import useEditeNews from '../../hooks/municipalityHooks/useEditeNews';


const EditeNewsModal = ({ visible, onClose}) => {
    const { form,setForm,getError,hasError,handleSubmit} = useEditeNews()
        ...
        <Modal visible={visible} animationType="slide" transparent>
            <View style={styles.modalOverlay}>
                ...
                >
                    ...
                    <Image
                        source={images.editeNews}
                        style={styles.image}
                    />
                    <Text style={styles.title}>update News</Text>
